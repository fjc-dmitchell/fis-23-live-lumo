...
@Component("fis_DocumentProcessingService")
public class DocumentProcessingService {
    private final UnconstrainedDataManager unconstrainedDataManager;

    public DocumentProcessingService(UnconstrainedDataManager unconstrainedDataManager) {
    ...
    Optional<Obligation> fetchObligation(Division division, String documentNumber, Integer lineNumber) {
    ...
    public Obligation createObligationFrom(ResolvedContext ctx) {
        ...
        newObligation.setActivity(ctx.activity());
        newObligation.setObjectClass(ctx.objectClass());
